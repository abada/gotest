    ...
    <div class="container">
        ...
        <div class="row">
            <div class="site-map center-block">
                ...
                <a href="#"><i class="fa fa-circle"></i> contact us</a>
                <a href="#"><i class="fa fa-circle"></i> order online</a>
                <ul class="social list-inline text-center">
                    <li><a href="#">follow us</a></li>
                    <li><a href="#"><i class="fa fa-facebook fa-lg"></i></a></li>
                    <li><a href="#"><i class="fa fa-tumblr fa-lg"></i></a></li>
                    <li><a href="#"><i class="fa fa-instagram fa-lg"></i></a></li>
                    <li><a href="#"><i class="fa fa-youtube fa-lg"></i></a></li>
                </ul>
                <a href="#"><i class="fa fa-circle"></i> site map</a>
            </div>
        </div>
    </div>
</div>