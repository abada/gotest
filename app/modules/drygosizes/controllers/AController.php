<?php
namespace app\modules\drygosizes\controllers;
...
use app\modules\drygosizes\models\Carousel;
...
class AController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if(($fileInstanse = UploadedFile::getInstance($model, 'image')))
                {
                    ...
                    if($model->validate(['image'])){
                        ...
                        if($model->save()){
                            $this->flash('success', Yii::t('easyii/drygosizesupdated', 'Carousel created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('easyii/drygosizesupdated', 'Carousel updated'));
                }
                else{
                    $this->flash('error', Yii::t('easyii/drygosizesupdated','Update error. {0}', $model->formatErrors()));
                }
                return $this->refresh();
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/drygosizesupdated', 'Carousel item deleted'));
    }
