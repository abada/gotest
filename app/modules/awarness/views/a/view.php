...
$this->title = Yii::t('easyii/awarness', 'View feedback');
$this->registerCss('.feedback-view dt{margin-bottom: 10px;}');

if($model->status == Feedback::STATUS_ANSWERED) {
    $this->registerJs('$(".send-answer").click(function(){return confirm("'.Yii::t('easyii/awarness', 'Are you sure you want to resend the answer?').'");})');
}
?>
...
<dl class="dl-horizontal feedback-view">
    ...
    <dt><?= Yii::t('easyii/awarness', 'Phone') ?></dt>
    <dd><?= $model->phone ?></dd>
    <?php endif; ?>
...
<hr>
<h2><small><?= Yii::t('easyii/awarness', 'Answer') ?></small></h2>
